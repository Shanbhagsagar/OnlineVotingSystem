...
// Check connection
    ...
    <body>       
            ...
            <ul class="menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="admin_elecmanage.php" class="active">Election Management</a></li>
                    </ul> 
        ...
        <div class="wrapper">
            <br/><h2>Manage/Handle your Elections</h2><br/>
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr><td>" . $row["eid"] . "</td><td>" . $row["etitle"] . "</td><td>" . $row["estart"] . "</td><td>" . $row["eend"] . "</td><td><a href='../../back/admin1/editelec.php?eid=" . $row["eid"] . "'>Edit</a>&nbsp;|&nbsp;<a href='../../back/admin1/delelec.php?pid=".$row["eid"]."'>Delete</a>&nbsp;|&nbsp;<a href='#'>Reset</a>&nbsp;|&nbsp;<a href='#'>Set&nbsp;Time</a></td></tr>";
                            }
                        } else {
